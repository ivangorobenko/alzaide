...
import {FileTacheQuotidienneRepository} from "./infrastructure/repository/file/FileTacheQuotidienneRepository";
...
export const configureRepositories = (): FileRepositories => ({
    ...
    tacheQuotidienneRepository: new FileTacheQuotidienneRepository("./storage/dynamic/tachesQuotidiennes.json"),
});
